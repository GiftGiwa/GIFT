...
function Experience() {
    ...
    return (
        <div className="horizontal-center" id = "experience">
            ...
            <ExperienceCard color="#45D4B2" id="build-lab" count={experience[0].count} company={experience[0].company} position={experience[0].position} bullets={experience[0].bullets}></ExperienceCard>
